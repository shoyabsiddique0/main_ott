...
class LoginModel extends AbstractModel {
  ...
  LoginModel({this.success, this.message, this.accesstoken, this.startupData});

  LoginModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    accesstoken = json['accesstoken'];
    startupData = json['startupData'] != null
        ? StartupData.fromJson(json['startupData'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (startupData != null) {
      data['startupData'] = startupData!.toJson();
    }
    return data;
  }
}
...
class StartupData {
  ...
  StartupData({this.success, this.message, this.data});
